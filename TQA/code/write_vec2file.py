...
network = generate_network_ready_files(word2vec_path,processed_data_path,is_test_data=False,word_vec_size=word_vec_size,max_q_length=max_q_length,max_option_length=max_option_length,max_opt_count=max_opt_count,max_sent_para=max_sent_para,max_words_sent=max_words_sent,op_path=None)
