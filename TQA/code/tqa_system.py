...
class tqa_system():
    ...
    def train_ndq_model(self):
        ...
        train_model.fit_generator(read_train_data.read_all_vectors_for_ndq(),steps_per_epoch=self.steps_per_epoch_ndq,epochs = self.nb_epoch,validation_data=None,validation_steps=self.validation_steps_ndq,verbose=1)
